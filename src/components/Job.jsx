...
const Job = () => {
  return (
    <>
      <div className='grid grid-cols-2 max-lg:grid-cols-1 responsivePad py-16 md:py-12 max-md:py-8 space-y-12 bg-c-4-0 text-c-3-0 font-satoshi md:space-x-10'>
        ...
        <div className='flex flex-col space-y-6'>
          ...
          <h2 className='h4 font-satoshi-black'>
            We get the job done! 
          </h2>
